...
public class Muovi {
    ...
    public Muovi(SymbolicConstant row, SymbolicConstant col, SymbolicConstant row1, SymbolicConstant col1) {
        this.row = row;
        this.col = col;
        this.row = row1;
        this.col = col1;
    ...
    //Mi restituisce il valore dei movimenti come interi
    ...
    public String toString() {
        return "muovi(" + row + "," + col + "," + row1 + "," + col1 + ")";
    }
}